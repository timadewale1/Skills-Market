        ...
        <div className="border-t border-gray-100 bg-white py-6">
          <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-5">
              {[["/terms","Terms"],["/privacy","Privacy"],["/contact","Contact"],["/" ,"Home"]].map(([href,label]) => (
                <a key={href} href={href} className="font-mono text-xs text-gray-400 hover:text-orange-500 transition-colors">{label}</a>
              ))}
            </div>
